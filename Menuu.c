...
do
   {menu0();
    ...
    { case 1 : j=ajout_contact(tab,nbr_contact);
               nbr_contact=nbr_contact+j;
      ...
      case 5 : printf("\n\ndonner le num de contact a supprimer");
        ...
        scanf("%d",&choixx);
               ...
               switch(choixx)
     {case 1 : afficher_tout_contact(tab,nbr_contact);break;

      case 2 : printf("donner le num de contact a afficher \t");
               scanf("%d",&num);
               affiche_contact_assoie(tab,nbr_contact);break;}

                 }while (choixx!=3);break;


            case 3:sauvegarder(tab,nbr_contact);/*enregistrer_fichier (tab,nbr_contact);*/
                   system("cls");
                            system("COLOR 1E");
                            printf("\n");
